" put this line first in ~/.vimrc
 ...
 \ shellescape(c.plugin_root_dir.'/vim-addon-manager', 1)
                                     ...
                                     " This provides the VAMActivate command,
"                                     you could be passing plugin names, too
"  call vam#ActivateAddons([], {})
                                   endfun                                       call SetupVAM()
"                                       " ACTIVATING PLUGINS
"
...
"                                      " use <c-x><c-p> to complete plugin
"                                       names
"                                       " OPTION 3: Create a file
"                                       ~/.vim-scripts putting a PLUGIN_NAME
"                                       into each line
"                                       " See lazy loading plugins section 
" .vimrc
set encoding=utf-8
